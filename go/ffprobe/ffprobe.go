...
func NewFFProbe(ffbinPath string) *FFProbe {
	return &FFProbe{}
}
...
func (f *FFProbe) SetFFProbeBinPath(newBinPath string) {
	f.binPath = newBinPath
}
...
func (f *FFProbe) ProbeURL(ctx context.Context, fileURL string, extraFFProbeOptions ...string) (data *ProbeData, err error) {
	args := append([]string{
		"-loglevel", "fatal",
		"-print_format", "json",
		"-show_format",
...
// This function takes a context to allow killing the ffprobe process if it takes too long or in case of shutdown.
// Any additional ffprobe parameter can be supplied as well using extraFFProbeOptions.
func (f *FFProbe) ProbeReader(ctx context.Context, reader io.Reader, extraFFProbeOptions ...string) (data *ProbeData, err error) {
	args := append([]string{
		"-loglevel", "fatal",
		"-print_format", "json",
		"-show_format",
...
func (f *FFProbe) runProbe(cmd *exec.Cmd) (data *ProbeData, err error) {
